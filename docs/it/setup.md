...
- **Agenti disponibili:** 10 agenti specializzati (build, plan, review, docs, ecc.)
...
Nessuna modifica è necessaria per l'uso base. Utenti avanzati possono modificare le configurazioni agente in `.opencode/`.
